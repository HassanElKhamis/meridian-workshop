export default {
  ...
  reports: {
    title: 'パフォーマンスレポート',
    description: '四半期パフォーマンス指標と月次動向の確認',
    ...
    avgOrderValue: '平均注文額',
    fulfillmentRate: '履行率',
    monthlyRevenueTrend: '月別収益動向',
    monthOverMonthAnalysis: '月次比較分析',
    month: '月',
    orders: '注文',
    revenue: '収益',
    change: '変化',
  ...
  restocking: {
    title: '補給推奨',
    description: '在庫レベル、需要予測、予算に基づくAI駆動の発注推奨',
    budget: '予算上限',
    budgetPlaceholder: '予算上限を入力（任意）',
    apply: '適用',
    ...
    budgetUsed: '予算使用率',
    withinBudget: '予算内',
    noRecommendations: '補給不要 — すべての品目に十分な在庫があります。',
    critical: '緊急',
    high: '高',
    medium: '中',
    low: '低'
